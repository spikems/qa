#! /usr/bin/python
# -*- coding:utf-8 -*-
from conf.modelbase import ModelBase
...
class WordsTrend(ModelBase):
    ...
    def master(self, query_list):
        brand_dict, product_dict, component_dict, attribute_dict, evaluation_dict, service_dict = {}, {}, {}, {}, {}, {}
...
if __name__ == '__main__':
    test = WordsTrend()
    test.master(['brand', 'product', 'component', 'attribute'])
